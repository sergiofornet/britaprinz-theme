...
if ( ! defined( 'BRITAPRINZ_THEME_VERSION' ) ) {
	...
	define( 'BRITAPRINZ_THEME_VERSION', '1.0.0' );
}
...
function britaprinz_theme_scripts() {
	...
	wp_enqueue_script( 'britaprinz-theme-navigation', get_template_directory_uri() . '/js/navigation.js', array(), BRITAPRINZ_THEME_VERSION, true );
