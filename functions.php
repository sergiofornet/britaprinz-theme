...
function britaprinz_theme_scripts() {
	wp_enqueue_style( 'britaprinz-theme-style', get_stylesheet_uri(), array(), _S_VERSION );
	wp_style_add_data( 'britaprinz-theme-style', 'rtl', 'replace' );

	wp_enqueue_script( 'britaprinz-theme-navigation', get_template_directory_uri() . '/js/navigation.js', array(), _S_VERSION, true );
