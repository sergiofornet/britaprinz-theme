...
module.exports = {
	...
	// Project options.
	projectURL: 'localhost:8888/britaprinz', // Local project URL of your already running WordPress site. Could be something like wpgulp.local or localhost:3000 depending upon your local WordPress setup.
	...
	// Translation options.
	textDomain: 'britaprinz-theme', // Your textdomain here.
	translationFile: 'britaprinz-theme.pot', // Name of the translation file.
	translationDestination: './languages', // Where to save the translation files.
	packageName: 'britaprinz-theme', // Package name.
